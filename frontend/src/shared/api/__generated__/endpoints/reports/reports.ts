 ...
 */
export type postReportBuildResponse200 = {
  data: Report;
  status: 200;
};

export type postReportBuildResponse400 = {
  data: BadRequestResponse;
  status: 400;
};

export type postReportBuildResponse401 = {
  data: UnauthorizedResponse;
  status: 401;
};

export type postReportBuildResponse402 = {
  data: PaymentRequiredResponse;
  status: 402;
};

export type postReportBuildResponse406 = {
  data: NotAcceptableResponse;
  status: 406;
};

export type postReportBuildResponse500 = {
  data: InternalErrorResponse;
  status: 500;
};

export type postReportBuildResponseComposite =
  | postReportBuildResponse200
  | postReportBuildResponse400
  | postReportBuildResponse401
  | postReportBuildResponse402
  | postReportBuildResponse406
  | postReportBuildResponse500;

export type postReportBuildResponse = postReportBuildResponseComposite & {
  headers: Headers;
};

export const getPostReportBuildUrl = () => {
  return `https://admin-api.docs.keitaro.io/report/build`;
};

export const postReportBuild = async (
  reportsRequest: ReportsRequest,
  options?: RequestInit,
): Promise<postReportBuildResponse> => {
  return fetcher<postReportBuildResponse>(getPostReportBuildUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(reportsRequest),
  });
};
 ...
 * @summary Get Labels
 */
export type getReportLabelsResponse200 = {
  data: Labels;
  status: 200;
};

export type getReportLabelsResponse400 = {
  data: BadRequestResponse;
  status: 400;
};

export type getReportLabelsResponse401 = {
  data: UnauthorizedResponse;
  status: 401;
};

export type getReportLabelsResponse402 = {
  data: PaymentRequiredResponse;
  status: 402;
};

export type getReportLabelsResponse404 = {
  data: NotFoundResponse;
  status: 404;
};

export type getReportLabelsResponse500 = {
  data: InternalErrorResponse;
  status: 500;
};

export type getReportLabelsResponseComposite =
  | getReportLabelsResponse200
  | getReportLabelsResponse400
  | getReportLabelsResponse401
  | getReportLabelsResponse402
  | getReportLabelsResponse404
  | getReportLabelsResponse500;

export type getReportLabelsResponse = getReportLabelsResponseComposite & {
  headers: Headers;
};

export const getGetReportLabelsUrl = (params: GetReportLabelsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `https://admin-api.docs.keitaro.io/report/labels?${stringifiedParams}`
    : `https://admin-api.docs.keitaro.io/report/labels`;
};

export const getReportLabels = async (
  params: GetReportLabelsParams,
  options?: RequestInit,
): Promise<getReportLabelsResponse> => {
  return fetcher<getReportLabelsResponse>(getGetReportLabelsUrl(params), {
    ...options,
    method: 'GET',
  });
};
 ...
 */
export type postReportLabelsResponse200 = {
  data: Success;
  status: 200;
};

export type postReportLabelsResponse400 = {
  data: BadRequestResponse;
  status: 400;
};

export type postReportLabelsResponse401 = {
  data: UnauthorizedResponse;
  status: 401;
};

export type postReportLabelsResponse402 = {
  data: PaymentRequiredResponse;
  status: 402;
};

export type postReportLabelsResponse404 = {
  data: NotFoundResponse;
  status: 404;
};

export type postReportLabelsResponse500 = {
  data: InternalErrorResponse;
  status: 500;
};

export type postReportLabelsResponseComposite =
  | postReportLabelsResponse200
  | postReportLabelsResponse400
  | postReportLabelsResponse401
  | postReportLabelsResponse402
  | postReportLabelsResponse404
  | postReportLabelsResponse500;

export type postReportLabelsResponse = postReportLabelsResponseComposite & {
  headers: Headers;
};

export const getPostReportLabelsUrl = () => {
  return `https://admin-api.docs.keitaro.io/report/labels`;
};

export const postReportLabels = async (
  labelRequestPost: LabelRequestPost,
  options?: RequestInit,
): Promise<postReportLabelsResponse> => {
  return fetcher<postReportLabelsResponse>(getPostReportLabelsUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(labelRequestPost),
  });
};
