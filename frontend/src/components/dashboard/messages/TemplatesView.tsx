...
import { CreateCategoryModal } from '@/components/dashboard/messages/CreateCategoryModal'
import CreateTemplateModal from '@/components/dashboard/messages/CreateTemplateModal'
import EditTemplateModal from '@/components/dashboard/messages/EditTemplateModal'
...
const initialTemplates: TemplateData[] = [
    {
        ...
        message: 'Здравствуйте! Спасибо за интерес к нашему предложению. Наш менеджер свяжется с вами в ближайшее время.',
        isActive: true
    },
    {
        title: 'Повторный контакт',
        category: 'Повторный Контакт',
        message: 'Добрый день! Мы пытались связаться с вами ранее. Есть выгодное предложение специально для вас.',
        isActive: true
    },
    {
        title: 'Срочное предложение',
        category: 'Срочное предложение',
        message: '🔥 Только сегодня! Получите скидку 30% при заказе в течение часа.',
        isActive: false
    },
    {
        title: 'Напоминание о заявке',
        category: 'Напоминание',
        message: 'Вы оставляли заявку на нашем сайте. Мы готовы проконсультировать вас по всем вопросам.',
        isActive: false
    },
    {
        title: 'Недозвон',
        category: 'Недозвон',
        message: 'Мы пытались дозвониться вам, но не удалось. Напишите нам в ответ или ждите нового звонка.',
        isActive: false
    }
]
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex flex-1 gap-4">
                    <Input placeholder="Поиск по названию или содержимому..." className="w-full" />
                    <Select value={category} onChange={setCategory} options={categoryOptions} placeholder="Категория" />
                    <Select value={status} onChange={setStatus} options={statusOptions} placeholder="Статус" />
                </div>
