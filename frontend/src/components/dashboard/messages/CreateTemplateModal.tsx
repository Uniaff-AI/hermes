...
export default function CreateTemplateModal({ open, onClose, onSubmit }: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-xl sm:rounded-xl sm:p-8">
                <DialogHeader>
                    <DialogTitle className="text-lg font-semibold">Создание нового сообщения</DialogTitle>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center space-y-2">
                            ...
                            />
                            <p className="text-xs text-muted-foreground">Максимум 5 файлов, до 10MB каждый</p>
                        </div>
                    </div>
                </div>
