            ...
            <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                        У вас пока нет созданных правил перенаправления.
                        Создайте первое правило для начала работы с системой.
                    </p>
    ...
    return (
        <>
            <div className="space-y-6">
                {rules.map((rule) => (
                    <Card key={rule.id} className="bg-white rounded-2xl border p-6 shadow">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <span className={`w-3 h-3 rounded-full ${rule.isActive ? 'bg-green-500' : 'bg-yellow-500'}`} />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-5 gap-x-8 gap-y-4 text-sm text-gray-600">
                            <div>
                                ...
                                <div className="font-medium text-gray-900">{rule.offerName}</div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="font-medium text-gray-900">{formatPeriod(rule.periodMinutes)}</div>
                            </div>
                            <div>
